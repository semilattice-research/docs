...
description: "Create custom populations from your survey data"
---
...
- Survey data in the [required CSV format](/populations/seed-data-requirements)
...
| `seed_data` | file/path | CSV file containing survey responses |
| `reality_target` | string | Description of the target demographic |
| `simulation_engine` | string | Engine version (typically "answers-1") |
| `simulation_options` | object | Additional configuration options |
...
### 1. Processing
Initially, your population will have a `status` of **"Processing"** while Semilattice trains the model on your data.
