...
Populations are the fundamental building block of Semilattice, connecting the platform to the real world.
...
Populations are pegged to a specific Simulation Engine when they are created. That Simulation Engine is then used to evaluate the Population and to produce all future predictions, ensuring the Population's evaluation scores represent its estimated accuracy for new predictions.
...
Populations can be public or private. All Semilattice users can view and use public Populations, while private Populations are only visable to and usable by their owners. Logged-out users can also view public Populations, but cannot make predictions with them.

<AccordionGroup>
  <Accordion title="Public permissions">
    | Permission       |         Owner         |    Logged-in users    |    Logged-out users   |
    | :--------------- | :-------------------: | :-------------------: | :-------------------: |
    | View & discover  | <Icon icon="check" /> | <Icon icon="check" /> | <Icon icon="check" /> |
    | Make predictions | <Icon icon="check" /> | <Icon icon="check" /> | <Icon icon="xmark" /> |
  ...
  <Accordion title="Private permissions">
    | Permission       |         Owner         |    Logged-in users    |    Logged-out users   |
    | :--------------- | :-------------------: | :-------------------: | :-------------------: |
    | View & discover  | <Icon icon="check" /> | <Icon icon="xmark" /> | <Icon icon="xmark" /> |
    | Make predictions | <Icon icon="check" /> | <Icon icon="xmark" /> | <Icon icon="xmark" /> |
    | Edit             | <Icon icon="check" /> | <Icon icon="xmark" /> | <Icon icon="xmark" /> |
  </Accordion>
</AccordionGroup>
