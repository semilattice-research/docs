...
Your CSV file should contain survey responses where each row represents one respondent and each column represents their answer to a multiple-choice question. This data trains your population model to make accurate predictions for similar groups.
...
## How Population Training Works

Your CSV data trains the population model, but predictions also leverage Semilattice's underlying AI. The training data acts as a "filter" that selects relevant knowledge from the AI model.
...
## Choosing Training Questions

The questions in your training data determine prediction accuracy. Better training questions lead to more accurate API responses.
...
<CardGroup cols={1}>
  <Card title="Target your API use case" icon="target">
    Choose training questions that relate to the types of predictions you'll make via API. Building a customer feedback population? Include questions about satisfaction, preferences, and demographics.
  </Card>
  ...
  <Card title="Maximize data quality" icon="chart-line">
    Aim for 20 questions and 1,000+ responses. More training data typically means better API prediction accuracy.
  </Card>
