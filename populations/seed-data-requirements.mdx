...
Open-ended questions cannot be simulated, but open-ended question data is used by population models to simulate single-choice and multiple-choice questions.
...
- there must be at least one **single-choice** or **multiple-choice** question column in your seed data file because [**open-ended** questions cannot be tested](/populations/evaluation#open-ended-questions-cannot-be-tested)
