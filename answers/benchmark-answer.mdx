...
response = semilattice.answers.benchmark(
...
const response = await semilattice.answers.benchmark({
    population_id: "d670f351-8567-4586-9bba-b81add1bebe3",
    answers: {
        question: "What's your primary role?",
        question_options: { question_type: "single-choice" },
...
Simulations run asynchronously. The initial response has `status: "Test Queued"`, and you need to poll for completion.
