...
<Update label="November 2025">
    ## Semilattice MCP
    [Semilattice MCP](/mcp/introduction) is a Model Context Protocol server that gives AI assistants the ability to predict how specific audiences would answer questions.
    
    Learn how to connect your AI assistant, IDE, or agentic tooling in the [getting started guide](/mcp/connect).
</Update>
<Update label="September 2025">
    ...
    #### Faster predictions
    - Predictions are now ~3x faster, taking less than 15 seconds. [Watch the demo video](http://semilattice.ai/latency.mp4) (has sound).
